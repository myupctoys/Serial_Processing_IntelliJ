...
<BR>
This has been done to help users to start using a proper JAVA ide when coming from processing. New users will quickly realize the benefits of context help, guidance and the plethora of other tools an IDE brings to the table.<BR><BR>
